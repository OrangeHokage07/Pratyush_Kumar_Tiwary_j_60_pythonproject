...
for i in range(student_no):
    ...
    if duplicate('Student.csv', student_id, 0):
        ...
        print(
            'please enter the subjects marks in the above mentioned order in a dictionary\n if you dont have a particular subject write there "null" (e.g. [100,100,"null",75,69,85])')
        ...
        with open(f"{path}/ReportCards/{student_id}_{''.join(name.split())}.txt", 'w') as f:
            ...
            f.write('\n')
            f.write(f'You have got {total_marks} in total with {total_marks/6}%\n')
